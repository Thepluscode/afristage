...
@Module({ imports: [JwtModule.register({}), ChatModule], controllers: [LiveRoomsController], providers: [LiveRoomsService, LiveKitService, RoomCleanupService], exports: [LiveRoomsService] })
