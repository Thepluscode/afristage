...
describe('AdminController', () => {
  function make() {
    const admin = { betaOpsDashboard: jest.fn(), dashboard: jest.fn(), users: jest.fn(), creators: jest.fn(), liveRooms: jest.fn(), payments: jest.fn(), ledgerTransactions: jest.fn(), auditLogs: jest.fn() };
  ...
  it('delegates the admin read endpoints', () => {
    ...
    c.betaOps(); c.ledgerIntegrityCheck(); c.dashboard(); c.users('q', 'ACTIVE', 'ADMIN'); c.creators('APPROVED');
