...
class _NotificationsScreenState extends State<NotificationsScreen> {
  // The AppBar "Mark all read" action lives outside the loader's builder, so
  // it reaches the reload through the loader's public state.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AfriLoader<List<dynamic>>(
        key: _loader,
        load: () => context.read<AppState>().api.getList('/notifications/me'),
